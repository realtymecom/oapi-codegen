...
import (
	...
	"github.com/realtymecom/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/realtymecom/oapi-codegen/v2/examples/authenticated-api/echo/server"
)
